...
def parsearg():
    ...
    window_size = args.window_size if args.window_size else 65535
    window_scale = args.window_scale if args.window_scale else 0
    confusion_times = args.confusion_times if args.confusion_times else 1
